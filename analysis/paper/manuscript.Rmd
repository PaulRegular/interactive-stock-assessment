...
TODO:
- Take screenshots of the dashboard for static figures for the paper (use webshot?)
- Remember to add reference to the supplement that will ultimately include the NCAM_dashboard.html
